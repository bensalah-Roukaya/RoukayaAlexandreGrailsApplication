<%@ page import="roukayaalexandregrailsapplication.User" %>
<!DOCTYPE html>
<html>
<head>
        ...
        <fieldset class="form">
            ...
            <div class="fieldcontain required">
                ...
                <select name="author.id" required="" id="author">
                    <g:each in="${roukayaalexandregrailsapplication.User.list()}" var="user">
            ...
            <div class="fieldcontain required">
                ...
                <select name="validTill_month" id="validTill_month" aria-labelledby="validTill"><option
                ...
                <div class="fieldcontain">
                    <span id="illustrations-label" class="property-label">Old Illustrations</span>
                ...
                <div class="fieldcontain">
                    <label for="state">State</label><input type="hidden" name="_state">
